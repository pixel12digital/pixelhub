 ...
 * 
 * EXECUÇÃO:
 * php scripts/migrate_leads_to_tenants_fixed.php [--dry-run] [--force]
 * 
 * OPTIONS:
...
class LeadMigration
{
    ...
    private function checkPrerequisites(): void
    {
        ...
        foreach ($requiredFields as $field) {
            ...
            if ($stmt->rowCount() === 0) {
                throw new \RuntimeException("Campo '{$field}' não encontrado na tabela tenants. Execute a migration migrate_add_lead_fields.php primeiro.");
            }
        }
...
try {
    $pdo = new PDO("mysql:host=pixelhub-db.c58i8jm2i1sa.us-east-1.rds.amazonaws.com;dbname=pixelhub;charset=utf8mb4", 'pixelhub', 'P@ssw0rd!@#2024');
