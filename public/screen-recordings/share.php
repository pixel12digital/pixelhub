...
try {
    ...
    $stmt = $db->prepare("
        SELECT 
            ...
            size_bytes, duration_seconds, has_audio, created_at
    ...
    // O file_path no banco é relativo: screen-recordings/2025/11/28/xxx.webm
    ...
    // Monta URL do vídeo
    // O arquivo está em public/screen-recordings/, então a URL é relativa a public/
    $basePath = defined('BASE_PATH') ? BASE_PATH : '';
    $relativePath = ltrim($recording['file_path'], '/');
    $videoUrl = $basePath . '/screen-recordings/' . $relativePath;
