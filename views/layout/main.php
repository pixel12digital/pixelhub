...
<body>
    ...
    <div class="container">
        <nav class="sidebar" id="sidebar">
            ...
            $integracoesOpen = $shouldExpand(['/settings/whatsapp-gateway', '/settings/smtp', '/settings/ai', '/settings/ai-contexts']);
