                ...
                <div class="sidebar-module-content <?= $configuracoesExpanded ? 'is-open' : '' ?>">
                    ...
                    <div class="sidebar-subgroup" data-subgroup="empresa">
                        ...
                        <div class="sidebar-subgroup-content <?= $empresaOpen ? 'is-open' : '' ?>">
                            ...
                            <a href="<?= pixelhub_url('/settings/users') ?>" class="sub-item <?= (strpos($currentUri, '/settings/users') !== false) ? 'active' : '' ?>">
    ...
    (function() {
        ...
        window.generateInboxAIDraft = function() {
            ...
            var payload = {
                ...
                tenant_id: thread.tenant_id || null, // Para análise de cobrança
            ...
            try {
                ...
                if (sessionSelect && data.whatsapp_sessions) {
                    ...
                    (data.whatsapp_sessions || []).forEach(s => {
                        ...
                        if (s.id) InboxState.sessionNames[s.id] = s.name || s.id;
                    });
                                ...
                                <div style="display: flex; align-items: center; gap: 6px; flex-shrink: 0;">
                                    <div class="incoming-lead-menu">
                                        ...
                                        <div class="incoming-lead-menu-dropdown">
                                            ...
                                            <button type="button" class="incoming-lead-menu-item" onclick="event.stopPropagation(); openEditContactNameModal(${convId}, '${contactName}'); closeIncomingLeadMenu(this);"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>Editar nome</button>
                                            ${ignoreBtn}
