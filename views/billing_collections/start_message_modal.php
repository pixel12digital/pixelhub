...
<div id="startMessageModal" class="modal" style="display: none;">
    ...
    <div class="modal-content" style="max-width: 700px; max-height: 90vh; overflow-y: auto;">
        ...
        <div class="modal-body" style="padding: 25px;">
            <!-- Resumo da Situação -->
            <div id="startMessageSummary" style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #666;">
                <div style="display: flex; justify-content: space-between; align-items: start; flex-wrap: wrap; gap: 15px;">
                    <div>
                        <div style="font-size: 13px; color: #666; margin-bottom: 5px;">Total em Aberto</div>
                        <div id="startTotalAmount" style="font-size: 24px; font-weight: 700; color: #333;">R$ 0,00</div>
                    </div>
                    <div>
                        <div style="font-size: 13px; color: #666; margin-bottom: 5px;">Faturas Vencidas</div>
                        <div id="startOverdueCount" style="font-size: 24px; font-weight: 700; color: #333;">0</div>
                    </div>
                    <div>
                        <div style="font-size: 13px; color: #666; margin-bottom: 5px;">A Vencer</div>
                        <div id="startPendingCount" style="font-size: 24px; font-weight: 700; color: #333;">0</div>
                    </div>
                </div>
            </div>
            ...
            <div style="margin-bottom: 20px;">
                ...
                <div id="startChannel" style="display: flex; gap: 10px; align-items: center;">
                    <span style="background: #666; color: white; padding: 6px 12px; border-radius: 4px; font-size: 12px; font-weight: 600;">
                        WhatsApp
                    </span>
                </div>
            </div>
            ...
            <!-- Aviso de Proteção -->
            <div style="background: #f8f9fa; border-left: 4px solid #666; padding: 12px; border-radius: 4px; margin-bottom: 20px;">
                <div style="display: flex; gap: 10px; align-items: start;">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#666" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink: 0; margin-top: 2px;">
    ...
    fetch(`/billing/get-start-message?id=${startMessageId}`)
        ...
        .then(data => {
            if (data.success) {
                ...
                // Tipo de mensagem
                const typeBadges = {
                    'billing_critical': '<span style="background: #666; color: white; padding: 6px 12px; border-radius: 4px; font-size: 12px; font-weight: 600;">CRÍTICO - Renegociação</span>',
                    'billing_collection': '<span style="background: #666; color: white; padding: 6px 12px; border-radius: 4px; font-size: 12px; font-weight: 600;">Cobrança</span>',
                    'billing_reminder': '<span style="background: #666; color: white; padding: 6px 12px; border-radius: 4px; font-size: 12px; font-weight: 600;">Lembrete</span>'
                };
                ...
                // Canal
                const channelIcons = {
                    'whatsapp': '<span style="background: #666; color: white; padding: 6px 12px; border-radius: 4px; font-size: 12px; font-weight: 600;">WhatsApp</span>',
                    'email': '<span style="background: #666; color: white; padding: 6px 12px; border-radius: 4px; font-size: 12px; font-weight: 600;">E-mail</span>',
                    'both': '<span style="background: #666; color: white; padding: 6px 12px; border-radius: 4px; font-size: 12px; font-weight: 600; margin-right: 5px;">WhatsApp</span><span style="background: #666; color: white; padding: 6px 12px; border-radius: 4px; font-size: 12px; font-weight: 600;">E-mail</span>'
                };
