...
class ProspectingService
{
    ...
    /**
     * Marca resultado como mensagem WA enviada e promove status para 'qualified' se ainda for 'new'.
     */
    ...
    public static function getCommonPlaceTypes(): array
    {
        return [
            '' => 'Qualquer tipo',
            // ── Tier 1: Alto risco + alto valor ─────────────────────────────────
            'jewelry_store'         => 'Joalheria',
            'optician'              => 'Ótica',
            'cell_phone_store'      => 'Loja de Celulares',
            'electronics_repair_shop' => 'Assistência Técnica (Celular/Eletrônico)',
            'electronics_store'     => 'Loja de Eletrônicos / Informática',
            'currency_exchange'     => 'Casa de Câmbio',
            'motorcycle_dealer'     => 'Loja de Motos',
            'bicycle_store'         => 'Loja de Bicicletas',
            'hardware_store'        => 'Loja de Ferramentas / Equipamentos',
            // ── Tier 2: Estoque + giro alto ─────────────────────────────────────
            'pharmacy'              => 'Farmácia / Drogaria',
            'supermarket'           => 'Supermercado / Mercado',
            'convenience_store'     => 'Conveniência / Mini Mercado',
            'liquor_store'          => 'Adega / Distribuidora de Bebidas',
            'cosmetics_store'       => 'Loja de Cosméticos / Perfumaria',
            'health_goods_store'    => 'Loja de Suplementos / Produtos Naturais',
            'pet_store'             => 'Loja de Ração / Pet Shop',
            'auto_parts_store'      => 'Autopeças / Moto Peças',
            // ── Tier 3: Comercial estruturado ────────────────────────────────────
            'veterinary_care'       => 'Clínica Veterinária / Pet Shop',
            'dental_clinic'         => 'Clínica Odontológica',
            'dentist'               => 'Consultório Odontológico',
            'skin_care_clinic'      => 'Clínica Estética',
            'barber_shop'           => 'Barbearia',
            'beauty_salon'          => 'Salão de Beleza',
            'gym'                   => 'Academia',
            'yoga_studio'           => 'Estúdio de Pilates / Yoga',
            'medical_clinic'        => 'Clínica Médica / Centro Médico',
            'medical_lab'           => 'Laboratório / Clínica de Exames',
            'physiotherapist'       => 'Clínica de Fisioterapia',
            // ── Tier 4: Serviços profissionais ──────────────────────────────────
            'lawyer'                => 'Escritório de Advocacia',
            'accounting'            => 'Escritório de Contabilidade',
            'real_estate_agency'    => 'Imobiliária',
            'coworking_space'       => 'Coworking',
            'school'                => 'Escola / Curso / Idiomas',
            'preschool'             => 'Escola Infantil / Creche',
            ...
            'gift_shop'             => 'Loja de Presentes / Variedades',
            'book_store'            => 'Papelaria / Livraria',
            'toy_store'             => 'Loja de Brinquedos',
            'furniture_store'       => 'Loja de Móveis / Decoração',
            'home_goods_store'      => 'Loja de Utilidades Domésticas / Cama Mesa e Banho',
            'appliance_store'       => 'Loja de Eletrodomésticos',
            'sporting_goods_store'  => 'Loja de Artigos Esportivos',
            'home_improvement_store'=> 'Loja de Construção / Materiais',
            'department_store'      => 'Magazine / Loja de Departamentos',
            'shopping_mall'         => 'Shopping / Centro Comercial',
            // ── Tier 6: Automotivo ───────────────────────────────────────────────
            'car_repair'            => 'Oficina Mecânica / Auto Elétrica / Funilaria',
            'car_wash'              => 'Lava-Car / Estética Automotiva',
            'tire_shop'             => 'Loja de Pneus / Borracharia',
            ...
            'grocery_store'         => 'Hortifruti / Frutaria',
            // ── Tier 8: Outros ───────────────────────────────────────────────────
            'hotel'                 => 'Hotel',
